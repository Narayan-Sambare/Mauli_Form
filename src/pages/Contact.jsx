...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(`https://wa.me/919021147485?text=${encodeURIComponent(msg)}`, "_blank");
    setSent(true);
    setTimeout(() => setSent(false), 3000);
  };

  const contacts = [
    { icon: "📍", title: "Our Location", value: "Wiwara, Malkapur, Maharashtra, India" },
    { icon: "📞", title: "Phone", value: "+91 9021147485" },
    { icon: "✉️", title: "Email", value: "info@maulifarm.in" },
    { icon: "🕐", title: "Working Hours", value: "Mon–Sat: 8 AM – 7 PM" },
    { icon: "💬", title: "WhatsApp", value: "+91 9021147485 (Fastest Response)" },
  ];
                ...
                <form onSubmit={handleSubmit}>
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input name="name" value={form.name} onChange={handleChange} placeholder="Sanket Patil" required />
                    </div>
                    <div className="form-group">
                      <label>Phone Number *</label>
                      <input name="phone" value={form.phone} onChange={handleChange} placeholder="+91 9021147485" required />
                    </div>
                  </div>
                  <div className="form-group">
                    <label>Email Address</label>
                    <input name="email" value={form.email} onChange={handleChange} placeholder="sanket@gmail.com" type="email" />
                  </div>
                  <div className="form-group">
