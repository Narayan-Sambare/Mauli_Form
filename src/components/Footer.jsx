        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-socials">
              <a href="https://wa.me/919021147485" className="social-btn" title="WhatsApp" target="_blank" rel="noreferrer">💬</a>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><a href="tel:+919021147485">📞 +91 99999 99999</a></li>
              <li><a href="mailto:info@maulifarm.in">✉️ info@maulifarm.in</a></li>
              <li><a href="https://wa.me/919021147485" target="_blank" rel="noreferrer">💬 WhatsApp Us</a></li>
            </ul>
          </div>
        </div>
